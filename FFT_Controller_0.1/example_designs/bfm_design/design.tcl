proc create_ipi_design { offsetfile design_name } {
	...
	set offset_file "${bd_path}/FFT_Controller_v0_1_tb_include.vh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef FFT_Controller_v0_1_tb_include_vh_"
	puts $fp "`define FFT_Controller_v0_1_tb_include_vh_\n"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:FFT_Controller:0.1]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/FFT_Controller_v0_1_tb.v
...
for { set i 1 } { 1 } { incr i } {
	set design_name "FFT_Controller_v0_1_bfm_${i}"
...
remove_files -quiet -fileset sim_1 FFT_Controller_v0_1_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top FFT_Controller_v0_1_tb [get_filesets sim_1]
